                ...
                <div class="col-lg-8 posts-list">
                    <div class="single-post">
                        <div class="feature-img">
                            <img class="img-fluid" src="https://via.placeholder.com/750x375?text=placeholder" alt="">
                        </div>
                        ...
                        <div class="navigation-area">
                            <div class="row">
                                <div class="col-lg-6 col-md-6 col-12 nav-left flex-row d-flex justify-content-start align-items-center">
                                    <div class="thumb">
                                        <a href="#">
                                            <img class="img-fluid" src="https://via.placeholder.com/60?text=placeholder" alt="">
                                        </a>
                                    </div>
                                    <div class="arrow">
                                        <a href="#">
                    ...
                    <div class="blog-author">
                        <div class="media align-items-center">
                            <img src="https://via.placeholder.com/90?text=placeholder" alt="">
                    ...
                    <div class="blog_right_sidebar">
                        ...
                        <aside class="single_sidebar_widget popular_post_widget">
                            ...
                            <div class="media post_item">
                                <img src="https://via.placeholder.com/80?text=placeholder" alt="post">
                                <div class="media-body">
                                    <a href="{{ url('/news/1') }}">
